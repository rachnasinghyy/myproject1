  ...
  render(){
    return(
      <div>
        ...
        <img src={require("./images/download.jpg").default} style={{'width':'250px'}}/>

        <img className="car-img" src="https://www.pexels.com/photo/close-up-photo-of-glowing-blue-butterflies-326055/"/>
